...
function check() {
  ...
  if (firstName.value == 0) {
    window.alert("your First Name is missing");
    firstName.focus();
    return false;
  }
  if (lastName.value == 0) {
    window.alert("your Last Name is missing");
    lastName.focus();
    return false;
  }
  if (email.value == 0) {
    window.alert("your Email is Missing");
    email.focus();

    return false;
  }
  if (username.value == 0) {
    window.alert("your Username is Missing");
    username.focus();
  ...
  if (password.value == 0) {
    window.alert("your Password is Missing");
    password.focus();

    return false;
  }
  if (contact.value == 0) {
    window.alert("your Contact Details are Missing");
    contact.focus();

    return false;
  }
  if (address.value == 0) {
    window.alert("your Address is Missing");
    address.focus();

    return false;
  }
  if (college.value == 0) {
    window.alert("your College Name is Missing");
    college.focus();
  ...
  if (nationality.value == 0) {
    window.alert("your Nationality is Missing");
    nationality.focus();
